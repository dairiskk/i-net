...
export async function generateMetadata({
  ...
  const localizedCategory = localizeCategory(category, "lv");
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[280px_1fr]">
        ...
        <section>
          <div className="flex items-center justify-between gap-4">
            <h2 className="text-2xl font-black text-stone-950">{categoryProducts.length} {copy.catalog.productsCount}</h2>
